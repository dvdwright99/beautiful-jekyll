...
Recall that our first observation with regard to path in Dr. Jobe's biomechanics lab was that the Putter would track the balance line in the feet.  This illustration shows a balance configuration where the putter path  would track inside out.
...
This illustration shows that this Putter Grip does not fit the either the left or right hand or neither hand.   You will need to check first the left hand and then the right hand, then both hands using the baseball grip on the putter.
...
![enter image description here](http://i.imgur.com/n1Ji0zL.jpg)
 ...
 This video was made 8 years ago and appeared online in 2012.  It still applies.  These materials are also available on line on our Products Page.

<iframe width="560" height="315" src="https://www.youtube.com/embed/Z-PYuyDS9a4?rel=0" frameborder="0" allowfullscreen></iframe> 

# **Baseball,** **Softball** & **Cricket** Grip Sizing

Baseball has been part of the Wright Balance research process since the early 2000s.  In 2009 I went with Dr. Michael Mellman to 7 time MLB All Star Reggie Smith's baseball hitting facility.  Reggie was working wtih Dodger Center Fielder, Matt Kemp.   I measured Matt for Stance Width and Bat handle size.  Matt took his yardstick and bat size and stepped into a hitting cage where he spent the next 30 minutes practicing striding from one Dominant Core Region Stance Width to another.  Matt was the first MLB player fit by Wright Balance.   Reggie Smith subsequently took the fitting system to MLB Spring training for 3 years in a row and we began to fit many MLB players in our Southern California Facility.

This video demonstrates testing bat handle size.  Note that the process is identical to Golf Grip Size Fitting.


<iframe width="560" height="315" src="https://www.youtube.com/embed/UC5nQN1E7Js?rel=0" frameborder="0" allowfullscreen></iframe>
...
Former 10 year MLB veteran, Mike Lamb was fit the last year of his career.   These are photo illustrations of Mike's bats before (left) and after (right) his Wright Balance Fitting.  Mike had his bat handle "cut" to his exact hand size.  As mentioned in the video above.  When Mike increased his bat handle size, he moved weight (3 oz.) out of the barrel into the handle.  This changed his bat size from 33 inches 31 ounces to 33 inches 34 ounces.  The perception of a "lighter" bat weight in the "heavier" bat is interesting.  These are changes I would encourage you t test.  The only way to test this weight change is to order the exact bat handle change.  We are working on determining how much you can increase bat weight (overall mass) and Power.
...
Mike began the grip size change by taping his bat to his exact hand sizes.  He said the bats would break at the top of the tape line.  After having his bats were "custom cut", the breakage stopped and, as he described, his power increased significantly with greater mass.
...
In this video Omar Vizquel, Mike Lamb and I discuss the similarities of a balanced stance width at the plate and in fielding.
