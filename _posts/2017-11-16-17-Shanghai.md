...
The Swing Catalyst Research Director, Dr. Scott Lynn came up with an simple way to understand the types of **Ground Reaction Forces** (**GRF**) by changing the labels of these Forces. The name changes are shown below:
1.  Linear or Horizontal Force he Labeled: **GLIDE**
2. Torque or Rotational Force he labeled:   **SPIN**
 3. Vertical Force he Labeled:  **LAUNCH** 
  
  
The Graphic illustrations below show the "**Glide**", "**Spin**" & "**Launch**" as it appears on the screen of the Swing Catalyst Monitor.  

![enter image description here](https://i.imgur.com/Qx7FWKI.jpg)

The corresponding video shown with the player creates a real time tracing that allows you to track the Ground Force through the swing.  You are able to see exactly in what "Swing Position" the player is when they create  the "**Glide**," "**Spin**," or "**Launch**" Face-On and Down the Line. 

![enter image description here](https://i.imgur.com/vLw08kH.jpg)

If you look carefully, you will see a wide black band above each of the Ground force tracings shown in the closeup below.

![enter image description here](https://i.imgur.com/LoqbPxy.jpg)   

That Black Band represents the Tour Player level of Ground Force use.  When paired with the video, you can see exactly where in the swing the Ground Force is produced 
...
**Lower Core** players who are trying to "Launch" are working against their natural recruitment of Power from the Ground.  The Lower Core Player uses "Glide" & "Spin".
...
![enter image description here](https://i.imgur.com/hjIOyPo.jpg)
...
![enter image description here](https://i.imgur.com/E7eMRar.jpg)

  
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzODc2ODU3NThdfQ==
-->